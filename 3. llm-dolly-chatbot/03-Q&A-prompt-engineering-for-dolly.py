...
# MAGIC To run this demo, just select the cluster `dbdemos-llm-dolly-chatbot-josh_melton` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/0501-131703-qhb6qpmi/configuration)). <br />
...
# MAGIC %pip install -U transformers langchain chromadb accelerate bitsandbytes sentence_transformers
...
# MAGIC
# MAGIC Open the next notebbok [04-chat-bot-prompt-engineering-dolly]($./04-chat-bot-prompt-engineering-dolly) to improve our chain and add memory between our interaction.
