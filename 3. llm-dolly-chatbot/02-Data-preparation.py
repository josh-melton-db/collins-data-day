...
# MAGIC %pip install -U chromadb langchain transformers accelerate sentence_transformers
...
# MAGIC %md
# MAGIC
# MAGIC ## 2/ Clean & prepare our gardening questions and best answers 
# MAGIC
...
if compute_embeddings: 
  ...
  db.similarity_search("dummy") # persist metadata
  db.persist()
